<template>
  <div class="box flex-column is-secondary-color pa-5">
    ...
    <div v-if="careFacility?.street || careFacility?.zip || careFacility?.town">
      <div class="py-3">
        <span class="d-flex align-center">
          ...
          <span class="is-secondary-color general-font-size">{{
            careFacility.street
          }}</span>
        </span>
        <div
        ...
        >
          ...
          <span class="mr-2 is-secondary-color general-font-size">
    ...
    <div
      class="mt-3"
      v-if="careFacility?.kind === 'facility' && careFacility.location"
    >
      <v-table density="compact">
        <tbody>
          ...
          <tr v-for="opening in careFacility.opening_hours" :key="opening.day">
            ...
            <td
              class="py-3 is-secondary-color general-font-size"
              v-if="opening.hours.length"
            >
              {{ opening.hours }}
            </td>
            <td class="py-3 is-secondary-color general-font-size" v-else>
              keine Angabe
            </td>
          </tr>
        </tbody>
