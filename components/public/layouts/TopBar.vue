<template>
	<div class="main">
		<v-app-bar v-model="appStore.showTopbar" :elevation="5" class="hero-menu" height="126">
			<v-app-bar-title>
			...
			<div class="navigation-drawer-content">
				...
				>
					<div class="d-flex align-center">
						...
						<span class="is-clickable general-font-size" @click="setItemsAndGo(category, null)">
							{{ category.name }}
						</span>
					</div>
				</div>
				<template v-if="!loading" class="main">
					...
					>
						<div class="d-flex align-center general-font-size">
							<img class="icons-menu mr-5" :src="iconCourse" />
							<span>Kurse</span>
						</div>
					</div>
					<div
