...
onMounted(async () => {
	...
	L.tileLayer(
		`https://api.maptiler.com/maps/1273b8ef-8485-4e5e-9b5f-0e676ef766c1/256/{z}/{x}/{y}.png?key=${config.public.MAPTILER_API_KEY}`,
		{
	...
	L.mask('/lk-wunsiedel.geojson', { fillOpacity: 0.7, restrictBounds: false }).addTo(map);
