					...
					<div class="py-10">
						<div>
							<span class="general-font-size is-dark-grey facility-kind-description">
								Hier kannst du eigene Kurse anlegen. Bitte fülle dazu wenn möglich alle Felder
								sorgfältig aus. Pflichtfelder sind mit einem Sternchen versehen.
							</span>
						</div>
					</div>
...
const steps: CreateEditSteps<StepNames> = {
	...
	website: {
		...
		tooltip:
			'Falls du keine eigene Website angeben möchtest, kannst du diesen Schritt überspringen.',
	...
	responsible: {
		label: '13.	Bitte gib hier den inhaltlich Verantwortlichen für die Kursinformationen an. *',
		tooltip: 'Der Name wird in deinem Kursprofil zu sehen sein.',
		description: 'Verantwortliche Person *',
		props: ['name_responsible_person'],
	},
	newfield: {
		label: '14.	Komplett neues Feld *',
		tooltip: 'Der Name wird in deinem Kursprofil zu sehen sein.',
		description: 'Beschreibung Neues Feld *',
		props: ['name'],
	},
};
