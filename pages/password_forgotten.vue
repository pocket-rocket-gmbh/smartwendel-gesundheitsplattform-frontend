			...
			<v-card :class="['pa-6', { shake: animated }]">
				...
				<div v-if="resetSuccessful" class="mt-3" align="center">
					<span class="general-font-size is-dark-grey">
						Das Zurücksetzen Deines Passworts wurde angefragt.
						<br />
						Bitte folge den Anweisungen in der E-Mail.
					</span>
					<div class="mt-5">
						<v-btn
							color="primary"
...
export default defineComponent({
	...
	setup() {
		...
		onMounted(() => {
			const rememberedEmail = localStorage.getItem('wunsiedel_teilhabeplattform._remembered_email');
