<template>
  <div class="general-font-size is-dark-grey">
    <v-container class="mt-10">
      ...
      <p>Internet: www.landkreis-st-Wunsiedel.de</p>
    ...
    <v-container>
      ...
      <p>
        Die Internetseiten des Landkreises Sankt Wunsiedel werden durch das Amt
        für Presse- und Öffentlichkeitsarbeit des Landkreises Sankt Wunsiedel
    ...
    <v-container>
      ...
      <p>
        ...
        unterliegen dem Urheberrecht. Sie dürfen von Ihnen nur zum privaten und
        sonstigen eigenen Gebrauch im Rahmen des § 53 Urheberrechtsgesetz (UrhG)
        verwendet werden. Eine Vervielfältigung oder Verwendung dieser Seiten
        ...
        Verantwortlichen. Weiterhin können Texte, Bilder, Grafiken und sonstige
        Dateien ganz oder teilweise dem Urheberrecht Dritter unterliegen. Auch
        über das Bestehen möglicher Rechte Dritter geben Ihnen die für den
        Inhalt Verantwortlichen nähere Auskünfte. Der Nachdruck und die
        Auswertung von Pressemitteilungen und Reden sind mit Quellenangabe
        allgemein gestattet.
      </p>
    </v-container>
    <v-container>
      <span class="font-weight-medium">Bildnachweis</span>
      <p>Landkreis St. Wunsiedel</p>
    </v-container>
    <v-container>
      ...
      <p>
        ...
        Verfügbarkeit der bereit gestellten In-formationen können wir allerdings
        nicht übernehmen. Ein Vertragsverhältnis mit den Nutzern des
        Internetangebots kommt nicht zustande. Wir haften nicht für Schäden, die
        durch die Nutzung dieses Internetangebots entstehen. Dieser
        ...
        Schadsoftware oder der Installation oder Nutzung von Software verursacht
    ...
    <v-container>
      ...
      <a
        class="is-dark-grey font-weight-medium"
        href="https://pocket-rocket.io"
        target="_blank"
      >
