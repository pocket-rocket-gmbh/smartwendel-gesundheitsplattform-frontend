<template>
  <div class="general-font-size is-secondary-color">
    ...
    <v-container>
      ...
      <p>
        Die Internetseiten des Landkreises Sankt Wendel werden durch das Amt für
        Presse- und Öffentlichkeitsarbeit des Landkreises Sankt Wendel betreut
        und gepflegt.
      </p>
    </v-container>
    <v-container>
    ...
    <v-container>
      ...
      <a
        class="is-secondary-color font-weight-medium"
