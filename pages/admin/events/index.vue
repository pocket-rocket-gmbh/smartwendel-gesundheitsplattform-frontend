	...
	<div>
		<v-row v-if="showBar">
			<v-col>
				...
				<span class="general-font-size is-dark-grey font-weight-bold" v-else>Veranstaltungen</span>
			</v-col>
		...
		<v-alert type="info" density="compact" closable class="my-2 general-font-size">
			Hier kannst du deine Veranstaltung anlegen. Je spezifischer deine Angaben sind, desto besser
			können dich Besucher auf der Webseite finden. Pflichtfelder sind mit einem Sternchen versehen.
		</v-alert>
		<v-alert density="compact" closable class="my-2 general-font-size">
			Leg hier deine Veranstaltung an. Veranstaltungen sind einmalige Ereignisse, die sich über
		...
		>
			Bitte kontrolliere zunächst, dass du deine Einrichtung angelegt hast und wir dich freigegeben
			haben. Danach kannst du Kurse, Veranstaltungen sowie Beiträge anlegen.
		</v-alert>
...
const fields = [
	{
		...
		disabledTooltip:
			'Dein Eintrag wird aktuell nicht auf der Teilhabeplattform angezeigt, da eine Prüfung durch den Plattformadministrator aussteht. Die Prüfung und anschließende Freigabe kann bis zu 48h in Anspruch nehmen, wir bitte um Geduld.',
		disabledTooltipFacilityImcomplete:
			'Dein Eintrag wird aktuell nicht auf der Teilhabeplattform angezeigt, da du noch nicht alle Pflichtfelder ausgefüllt hast.',
	},
