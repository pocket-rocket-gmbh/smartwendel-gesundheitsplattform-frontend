<template>
	<div>
		...
		<v-alert type="info" density="compact" closable class="my-2 general-font-size">
			Hier kannst du deine Kurse anlegen. Je spezifischer deine Angaben sind, desto besser können
			dich Besucher auf der Webseite finden. Pflichtfelder sind mit einem Sternchen versehen.
		</v-alert>
		<v-alert density="compact" closable class="my-2 general-font-size">
			Leg hier deinen Kurs an. Kurse sind wiederkehrende Ereignisse (wöchentlich, etc.)
		</v-alert>
