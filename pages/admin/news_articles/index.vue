<template>
	<div>
		...
		>
			...
			haben. Danach kannst du Kurse und Veranstaltungen sowie Beiträge anlegen.
		</v-alert>
...
const fields = [
	{
		...
		disabledTooltip:
			'Dein Eintrag wird aktuell nicht auf der Teilhabelattform angezeigt, da eine Prüfung durch den Plattformadministrator aussteht. Die Prüfung und anschließende Freigabe kann bis zu 48h in Anspruch nehmen, wir bitte um Geduld.',
		disabledTooltipFacilityImcomplete:
			'Dein Eintrag wird aktuell nicht auf der Teilhabelattform angezeigt, da du noch nicht alle Pflichtfelder ausgefüllt hast.',
	},
